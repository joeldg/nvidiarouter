...
4. Call MCP `begin_task` for the task, project type `CLI Tool / Developer Tooling`, and repo `github.com/joeldg/nvidiarouter`.
5. Call MCP `get_specs` for project type `CLI Tool / Developer Tooling` and repo `github.com/joeldg/nvidiarouter`.
